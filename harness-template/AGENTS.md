...
> **Por quê:** LLMs não têm memória entre sessões. Este protocolo garante que toda sessão começa do mesmo estado, independente da ferramenta usada.
...
- **O que faz (1 frase):** [DESCRIÇÃO EM UMA FRASE]
- **Para quem (uso pessoal / negócio / cliente):** [PÚBLICO]
- **Idioma da interface e do conteúdo:** [ex.: pt-BR]
- **Idioma do código e commits:** [ex.: inglês]
...
- **Frontend/Framework:** [ex.: Vite + React + TypeScript / Next.js / nenhum]
- **Backend/Runtime:** [ex.: Node + Fastify / Python + FastAPI / NENHUM]
- **Banco de dados:** [ex.: Postgres via Supabase / SQLite / NENHUM]
- **Hosting/Deploy:** [ex.: GitHub Pages via Actions / Vercel / VPS]
- **Repo:** [github.com/USUARIO/REPO]
- **Autenticação:** [ex.: nenhuma / OAuth / e-mail+senha]
- **Integrações externas:** [APIs de terceiros, com URL e se exigem chave]
- **Gerenciador de pacotes:** [ex.: npm / pnpm / uv]
- **Comandos canônicos:** teste: `[COMANDO]` · build: `[COMANDO]` · lint: `[COMANDO]`
...
| 2. Planejar | seções 5-8 do spec | Plano numerado, cada passo com verificação; zero perguntas abertas |
...
- [OUTRAS AÇÕES SENSÍVEIS ESPECÍFICAS DESTE PROJETO]
...
- NEVER adicionar backend, banco de dados ou serviço externo novo sem atualizar este arquivo antes
- [PROIBIÇÃO ESPECÍFICA DO DOMÍNIO — ex.: rate limits de API externa, janelas de dados, restrições legais]
- [PROIBIÇÃO ESPECÍFICA DO DOMÍNIO]
...
├── PROMPTS.md             ← prompts prontos por momento do ciclo
├── specs/
